...
public class Meal {
	...
	public Meal(Integer id, String name, Integer kcalories, String description, Integer categoryId) {
		super();
		this.id = id;
		this.name = name;
	...
	public String toString() {
		return "Meal [id=" + id + ", name=" + name + ", kcalories=" + kcalories + ", description=" + description
